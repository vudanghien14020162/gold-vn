...
function getPageSchemas(activePage, seo) {
  const commonSchemas = [
    buildWebsiteSchema(),
    buildOrganizationSchema(),
    buildBreadcrumbSchema([
  ...
  if (activePage === "home") {
    return [...commonSchemas, buildDatasetSchema(), buildFAQSchema()];
  }

  if (activePage === "price" || activePage === "world") {
    return [...commonSchemas, buildDatasetSchema()];
  }
  ...
  return (
    <>
      <SEOHead
        ...
        path={seo.path}
        schemas={getPageSchemas(activePage, seo)}
      />
